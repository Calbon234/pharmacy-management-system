...
export default function Inventory() {
  ...
  const S = {
    ...
    skeleton: { background: "linear-gradient(90deg,#f0f4f8 25%,#e8eef5 50%,#f0f4f8 75%)", backgroundSize:"200% 100%", animation:"shimmer 1.2s infinite", borderRadius:8 },
  };
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:14,marginBottom:20}}>
        {[
          ...
          <div key={i} style={{...S.card,padding:20,position:"relative",overflow:"hidden"}}>
            ...
            {loading ? <div style={{...S.skeleton,height:60}}/> : <>
          ...
          <table style={{width:"100%",borderCollapse:"collapse"}}>
            ...
            <tbody>
              {loading ? [1,2,3,4,5].map(i=>(
                <tr key={i}><td colSpan={8} style={{padding:"12px 16px"}}><div style={{...S.skeleton,height:20}}/></td></tr>
              )) : paginated.length === 0 ? (
